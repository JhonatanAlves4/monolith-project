...
describe("PlaceOrderUsecase unit test", () => {
  describe("validateProducts method", () => {
    ...
    it("should throw an error when product is off stock", async () => {
  ...
  describe("execute method", () => {
    ...
    describe("place an order", () => {
      ...
      const placeOrderUsecase = new PlaceOrderUsecase(
       ...
       // Simulate clientFacade being set before calling find
       placeOrderUsecase["_clientFacade"] = mockClientFacade as any;

       // Simulate clientFacade being set before calling find
       placeOrderUsecase["_repository"] = mockCheckoutRepo as any;
